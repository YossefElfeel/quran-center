-- seed.sql — بيانات أولية (idempotent). بيتشغّل بعد الـ migrations عند db reset.
-- بيانات القرآن المرجعية (114 سورة + الأجزاء/الصفحات) هتتضاف مع migration المرجعي الجاي.

-- إعدادات النظام الافتراضية (قابلة للتغيير من لوحة السوبر أدمن).
